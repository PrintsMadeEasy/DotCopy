 ...
 */
  ...
  * 
  * @version $Id: GoogleRequest.php,v 1.2 2010/01/03 07:47:09 brian_dot Exp $
  ...
  */
  ...
  class GoogleRequest {
    ...
    function SendChargeOrder($google_order, $amount='') {
      $postargs = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><charge-order xmlns=\"".$this->schema_url. "\" google-order-number=\"". $google_order. "\">";
      if ($amount != '') {
    ...
    function SendRefundOrder($google_order, $amount, $reason, $comment='') {
      ...
      $postargs = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><refund-order xmlns=\"" . $this->schema_url . "\" google-order-number=\"". $google_order. "\">" . "<reason>". $reason . "</reason>";
      if($amount!=0) {
    ...
    function SendCancelOrder($google_order, $reason, $comment) {
      ...
      $postargs = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>
                  ...
                  <reason>".
                    (substr(htmlentities(strip_tags($reason)),0,140)) .
                  "</reason>
                  <comment>".
                    (substr(htmlentities(strip_tags($comment)),0,140)) .                   
                  "</comment>
                  </cancel-order>";
    ...
    function SendBuyerMessage($google_order, $message, $send_mail="true", $timeout=false) {
      ...
      $postargs = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>
                  ...
                  "\" google-order-number=\"". $google_order . "\">
                  <message>" . 
            (substr(htmlentities(strip_tags($message)),0,254)) 
               . "</message>
 ...
 */
    ...
    function GetAuthenticationHeaders() {
      ...
      $headers[] = "User-Agent: Checkout PHP";
