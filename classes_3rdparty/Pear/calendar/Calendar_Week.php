...
// +----------------------------------------------------------------------+
//
// $Id: Calendar_Week.php,v 1.1 2008/10/30 16:14:38 brian_dot Exp $
//
/**
 * @package Calendar
 * @version $Id: Calendar_Week.php,v 1.1 2008/10/30 16:14:38 brian_dot Exp $
 */
...
class Calendar_Week extends Calendar
{
    ...
    function prevWeek($format = 'n_in_month')
    {
        ...
        exit("Illegal format in method Week->prevWeek");
    }
    ...
    function thisWeek($format = 'n_in_month')
    {
        ...
        exit("Illegal format in method Week->thisWeek");
    }
    ...
    function nextWeek($format = 'n_in_month')
    {
        ...
        exit("Illegal format in method Week->nextWeek");
    }
