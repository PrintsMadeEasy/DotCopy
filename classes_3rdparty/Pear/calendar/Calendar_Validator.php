...
// +----------------------------------------------------------------------+
//
// $Id: Calendar_Validator.php,v 1.1 2008/10/30 16:14:38 brian_dot Exp $
//
/**
 * @package Calendar
 * @version $Id: Calendar_Validator.php,v 1.1 2008/10/30 16:14:38 brian_dot Exp $
 */
...
class Calendar_Validator
{
    ...
    /**
     * Calls all the other isValidXX() methods in the validator
     * @return boolean
     * @access public
     */
    function isValid()
