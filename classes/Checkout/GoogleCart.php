 ...
 * @version $Id: GoogleCart.php,v 1.2 2010/01/03 07:47:09 brian_dot Exp $
 */
...
//      New Digital Delivery Tags
        if($item->digital_content) {
          ...
          if(!empty($item->digital_url)) {
            $xml_data->element('description', substr($item->digital_description, 0, 1024));
...
//        $ShippingPackage = $ship->ShippingPackage;
     ...
     */
    function CheckoutServer2ServerButton($url, $size="large", $variant=true, $loc="en_US",$style="trans") {
