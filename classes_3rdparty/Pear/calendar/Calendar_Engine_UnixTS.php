...
// +----------------------------------------------------------------------+
//
// $Id: Calendar_Engine_UnixTS.php,v 1.1 2008/10/30 16:14:38 brian_dot Exp $
//
/**
 * @package Calendar
 * @version $Id: Calendar_Engine_UnixTS.php,v 1.1 2008/10/30 16:14:38 brian_dot Exp $
 */
/**
...
class Calendar_Engine_UnixTS /* implements Calendar_Engine_Interface */
{
    ...
    {
        $min = strpos(PHP_OS, 'WIN') === false ? 1902 : 1970;
        return $min;
    }
