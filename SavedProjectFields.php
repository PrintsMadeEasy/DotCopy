...
$t->set_file("origPage", "SavedProjectFields-template.html");
...
$ArtworkXMLstring = ArtworkLib::GetArtXMLfile($dbCmd, 'saved', $projectrecord);
...
if(!empty($Action)){
	if($Action == "save"){
		...
		ArtworkLib::SaveArtXMLfile($dbCmd, "saved", $projectrecord, $ArtworkInfoObj->GetXMLdoc());
...
VisitorPath::addRecord("Saved Projects Text Fields");
