...
// +----------------------------------------------------------------------+
//
// $Id: Calendar_Decorator.php,v 1.1 2008/10/30 16:14:38 brian_dot Exp $
//
/**
 * @package Calendar
 * @version $Id: Calendar_Decorator.php,v 1.1 2008/10/30 16:14:38 brian_dot Exp $
 */
/**
...
class Calendar_Decorator
{
    ...
    {
        $this->calendar->setSelected($state);
    }
