========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : XMLMailSender
========================================================================


Diese XMLMailSender-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
Ihre XMLMailSender-Anwendung bilden.
...
XMLMailSender.h
	...
	Anwendungsklasse CXMLMailSenderApp.
...
res\XMLMailSender.ico
    Dies ist eine Symboldatei, die als Symbol für die Anwendung verwendet wird. Dieses 
	Symbol wird durch die Haupt-Ressourcendatei XMLMailSender.rc eingebunden.

res\XMLMailSender.rc2
...
XMLMailSenderDlg.h, XMLMailSenderDlg.cpp - das Dialogfeld
    	Diese Dateien enthalten die Klasse CXMLMailSenderDlg. Diese Klasse legt das
    	Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
	felds befindet sich in XMLMailSender.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
	...
	XMLMailSender.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
