// See documentation at http://www.svendtofte.com/code/date_format/ ... or use PHP Date format letters
...
Date.prototype.formatDate = function (input,time) {
    ...
    function g() {
        ...
        var retStr = self.getHours() > 12? self.getHours()-12 : self.getHours();
        if(retStr == 0)
        	retStr = 12;
        return retStr;
    }
    ...
    while (ia[ij]) {
        if (ia[ij] == "\\") {
        	...
        	// Make sure that the element exists first.
