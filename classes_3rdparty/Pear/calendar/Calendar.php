...
// +----------------------------------------------------------------------+
//
// $Id: Calendar.php,v 1.4 2008/10/30 16:14:38 brian_dot Exp $
//
/**
 * @package Calendar
 * @version $Id: Calendar.php,v 1.4 2008/10/30 16:14:38 brian_dot Exp $
 */
...
class Calendar
{
    ...
    function returnValue($returnType, $format, $stamp, $default)
    {
        ...
        exit("Illegal format in method Calendar->ReturnValue");
    }
    ...
    function build($sDates = array())
    {
        ...
        var_dump($sDates); // to keep the ID from complaining the value is unused.
        return false;
    }
