========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : EmailGenerator
========================================================================


Diese EmailGenerator-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
Ihre EmailGenerator-Anwendung bilden.
...
EmailGenerator.h
	...
	Anwendungsklasse CEmailGeneratorApp.
...
res\EmailGenerator.ico
    Dies ist eine Symboldatei, die als Symbol für die Anwendung verwendet wird. Dieses 
	Symbol wird durch die Haupt-Ressourcendatei EmailGenerator.rc eingebunden.

res\EmailGenerator.rc2
...
EmailGeneratorDlg.h, EmailGeneratorDlg.cpp - das Dialogfeld
    	Diese Dateien enthalten die Klasse CEmailGeneratorDlg. Diese Klasse legt das
    	Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
	felds befindet sich in EmailGenerator.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
	...
	EmailGenerator.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
