...
// +----------------------------------------------------------------------+
//
// $Id: Calendar_Engine_PearDate.php,v 1.1 2008/10/30 16:14:38 brian_dot Exp $
//
/**
 * @package Calendar
 * @version $Id: Calendar_Engine_PearDate.php,v 1.1 2008/10/30 16:14:38 brian_dot Exp $
 */
/**
 * Load PEAR::Date class
 */

// Got rid fo for Now to Avoid DLL hell
...
class Calendar_Engine_PearDate /* implements Calendar_Engine_Interface */
{
    ...
    {
    	// To Keep the IDE from complaining... this software dude tried to make the design too abstract.
        $returnVal = 7;
